...
function ecommerce_solution_notice(){
    ...
    <div class="notice notice-success is-dismissible getting_started">
		<div class="notice-content">
			...
			<h2><?php esc_html_e( 'Thanks for installing Ecommerce Solution Lite, you rock!', 'ecommerce-solution' ) ?> </h2>
			<p><?php esc_html_e( 'Take benefit of a variety of features, functionalities, elements, and an exclusive set of customization options to build your own professional Ecommerce Solution website.', 'ecommerce-solution' ) ?></p>
			<p><?php esc_html_e( "Please Click on the link below to know the theme setup information", 'ecommerce-solution' ) ?></p>
			<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=ecommerce-solution-guide-page' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Getting Started With Ecommerce Solution', 'ecommerce-solution' ); ?></a></p>
		</div>
	</div>
	<?php }
}
