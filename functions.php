...
function ecommerce_solution_setup() {
	...
	//this was changed from a blank slate
...
function ecommerce_solution_scripts() {
	...
	';
	wp_add_inline_style('ecommerce-solution-basic-style', $custom_css);
...
define('ECOMMERCE_SOLUTION_LIVE_DEMO','https://buywptemplates.com/bwt-ecommerce-solution-pro/','ecommerce-solution');
define('ECOMMERCE_SOLUTION_BUY_PRO','https://www.buywptemplates.com/themes/ecommerce-wordpress-template/','ecommerce-solution');
define('ECOMMERCE_SOLUTION_PRO_DOC','https://www.buywptemplates.com/demo/docs/bwt-ecommerce-solution-pro/','ecommerce-solution');
define('ECOMMERCE_SOLUTION_FREE_DOC','https://buywptemplates.com/demo/docs/free-bwt-ecommerce-solution/','ecommerce-solution');
define('ECOMMERCE_SOLUTION_PRO_SUPPORT','https://www.buywptemplates.com/support/','ecommerce-solution');
define('ECOMMERCE_SOLUTION_FREE_SUPPORT','https://wordpress.org/support/theme/ecommerce-solution/','ecommerce-solution');

define('ECOMMERCE_SOLUTION_CREDIT','https://buywptemplates.com','ecommerce-solution');

if ( ! function_exists( 'ecommerce_solution_credit' ) ) {
	function ecommerce_solution_credit(){
		echo "<a href=".esc_url(ECOMMERCE_SOLUTION_CREDIT)." target='_blank'>".esc_html__('Buywptemplates','ecommerce-solution')."</a>";
	}
}
